package coma112.csuggestion.version.nms.v1_19_R1;
...
public class Version implements ServerVersionSupport {
    ...
    public Version(@NotNull Plugin plugin) {
        SuggestionLogger.info("Loading support for version 1.19.1...");
        SuggestionLogger.info("Support for 1.19.1 is loaded!");
    }
