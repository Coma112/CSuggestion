package coma112.csuggestion.version.nms.v1_18_R1;
...
public class Version implements ServerVersionSupport {
    ...
    public Version(@NotNull Plugin plugin) {
        SuggestionLogger.info("Loading support for version 1.18.1...");
        SuggestionLogger.info("Support for 1.18.1 is loaded!");
    }
