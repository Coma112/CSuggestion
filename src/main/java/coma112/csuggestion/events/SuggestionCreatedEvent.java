...
@Getter
public final class SuggestionCreatedEvent extends Event implements PlaceholderProvider {
    private static final HandlerList handlers = new HandlerList();
    private final Player player;
    private final String suggestion;

    public SuggestionCreatedEvent(@Nullable Player player, @NotNull String suggestion) {
